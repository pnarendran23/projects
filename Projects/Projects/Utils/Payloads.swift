        ...
        for s in certificationsarray{
            ...
            if(str != ""){
                if(certifications.count > 0){
                    ...
                    str = str.replacingOccurrences(of: ":", with: "%3A")
                    certifications = "%28certification_level:%28" + "\"" + str + "\""
                }
            }
        }
        ...
        for s in ratingsarray{
            ...
            if(str != ""){
                if(ratings.count > 0){
                    ...
                    if(certifications.count == 0){
                        str = str.replacingOccurrences(of: ":", with: "%3A")
                        ratings = "%28rating_system:%28" + "\"" + str + "\""
                    }else{
                        str = str.replacingOccurrences(of: ":", with: "%3A")
                        ratings = "%20AND%20%28rating_system:%28" + "\"" + str + "\""
                    }
                }
            }
        }
            ...
            if(str != ""){
                if(versions.count > 0){
                    ...
                    if(ratings.count == 0 && certifications.count == 0){
                        str = str.replacingOccurrences(of: ":", with: "%3A")
                        versions = "%28rating_system_version:%28" + "\"" + str + "\""
                    }else{
                        str = str.replacingOccurrences(of: ":", with: "%3A")
                        versions = "%20AND%20%28rating_system_version:%28" + "\"" + str + "\""
                    }
                }
            }
        }
